...
func CreateDynamicWorkflow(workflowDef *yaml.WorkflowDefinition, project *yaml.Project, registry *compiler.ActivityRegistry, comp *compiler.Compiler) interface{} {
