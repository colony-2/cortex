...
func TestIntegration_SequenceWithTemplates(t *testing.T) {
	...
	ctx, err := NewResolutionContext("sequence", "data-pipeline")
...
func TestIntegration_StateMachineWithNestedSequence(t *testing.T) {
	...
	smCtx, err := NewResolutionContext("state_machine", "order-workflow")
	require.NoError(t, err)
...
func TestIntegration_RetryScenario(t *testing.T) {
	...
	ctx, err := NewResolutionContext("sequence", "retry-workflow")
	require.NoError(t, err)
...
func TestIntegration_ComplexCELExpressions(t *testing.T) {
	ctx, err := NewResolutionContext("state_machine", "decision-workflow")
	require.NoError(t, err)
