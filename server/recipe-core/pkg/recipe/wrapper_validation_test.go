...
func TestOpInputs_Normal_Decode_Succeeds(t *testing.T) {
    ...
    op := ops.NewActivityMappedOp(
        ...
        func(ctx context.Context, in normalIn) (normalOut, error) { return normalOut{M: in.N}, nil },
    )
    ops.Register(op)
...
func TestOpInputs_Wrapper_UnmarshalYAML_Validation_Invoked(t *testing.T) {
    ...
    op := ops.NewActivityMappedOp(
        ...
        func(ctx context.Context, in wrapperIn) (normalOut, error) { return normalOut{M: 0}, nil },
    )
    ops.Register(op)
