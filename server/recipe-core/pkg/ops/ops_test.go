...
func TestOps_Register_Get_List_Clear(t *testing.T) {
	...
	op := NewActivityMappedOpV2[dummyIn, dummyOut](OpMetadata{Type: "t1"}, func(_ Invocation, _ task.Context, in dummyIn) (dummyOut, error) {
	...
	op2 := NewActivityMappedOpV2[dummyIn, dummyOut](OpMetadata{Type: "t1"}, func(_ Invocation, _ task.Context, in dummyIn) (dummyOut, error) {
...
func TestOps_ThreadSafety(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		...
		go func() {
			...
			Register(NewActivityMappedOpV2[dummyIn, dummyOut](OpMetadata{Type: name}, func(_ Invocation, _ task.Context, in dummyIn) (dummyOut, error) {
				return dummyOut{B: in.A}, nil
			}))
		}()
	}
