...
func GetOp() ops.RegisterableOp {
	return ops.NewActivityMappedOpV2[SquashRebaseMergeInput, SquashRebaseMergeOutput](NewActivity().GetMetadata(), func(inv ops.Invocation, ctx context.Context, input SquashRebaseMergeInput) (SquashRebaseMergeOutput, error) {
