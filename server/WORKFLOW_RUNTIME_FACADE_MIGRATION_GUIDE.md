...
type WorkflowRuntime interface {
    ...
    PutArtifacts(ctx context.Context, req swf.PutArtifactsRequest) ([]swf.StoredArtifact, error)
}
```
...
func (r *MyRuntime) PutArtifacts(ctx context.Context, req swf.PutArtifactsRequest) ([]swf.StoredArtifact, error) { ... }
```
