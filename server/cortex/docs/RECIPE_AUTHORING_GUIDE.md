...
This guide explains how to write VibeThis recipes, discover available operations, and apply the scoping and templating rules that govern recipe execution.
...
Use the templating features summarised in `server/recipe-worker/test-fixtures/TEMPLATE_REFERENCE_CHEATSHEET.md` to reference inputs and outputs. Key patterns:
