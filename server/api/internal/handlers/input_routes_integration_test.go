...
type suiteWorkflowCtl2 struct{ env *testsuite.TestWorkflowEnvironment }
...
func (c *suiteWorkflowCtl2) Cancel(ctx context.Context, ref workflowctl.ExecutionRef, reason string) error { return nil }
